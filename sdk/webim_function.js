...
define(function(require) {
	...
	var proto_modifyGroupMember = function(options, cbOk, cbErr) {
		...
		ConnManager.apiCall(SRV_NAME.GROUP, "modify_group_member_info", options,
			cbOk, cbErr);
	};
	//删除群组成员
	...
	return {
		...
		//c2c消息子类型
		C2C_MSG_SUB_TYPE: C2C_MSG_SUB_TYPE,

		//群消息子类型
		GROUP_MSG_SUB_TYPE: GROUP_MSG_SUB_TYPE,

		//消息元素类型
		MSG_ELEMENT_TYPE: MSG_ELEMENT_TYPE,

		//群提示消息类型
		GROUP_TIP_TYPE: GROUP_TIP_TYPE,

		//图片类型
		IMAGE_TYPE: IMAGE_TYPE,

		//群系统消息类型
		GROUP_SYSTEM_TYPE: GROUP_SYSTEM_TYPE,

		//好友系统通知子类型
		FRIEND_NOTICE_TYPE: FRIEND_NOTICE_TYPE,

		//群提示消息-群资料变更类型
		GROUP_TIP_MODIFY_GROUP_INFO_TYPE: GROUP_TIP_MODIFY_GROUP_INFO_TYPE,
		...
		//表情对象
		Emotions: emotions,
		EmotionPicData: emotions,
		//表情标识符和index Map
		EmotionDataIndexs: emotionDataIndexs,
		EmotionPicDataIndex: emotionDataIndexs,
		//腾讯登录服务错误码(托管模式)
		...
		//上传图片业务类型
		UPLOAD_PIC_BUSSINESS_TYPE: UPLOAD_PIC_BUSSINESS_TYPE,

		//最近联系人类型
		RECENT_CONTACT_TYPE: RECENT_CONTACT_TYPE,

		//上传资源类型
		UPLOAD_RES_TYPE: UPLOAD_RES_TYPE,
		...
		//基本接口
		//登录
		login: function(loginInfo, listeners, opts, cbOk, cbErr) {
		...
		init: function(loginInfo, listeners, opts, cbOk, cbErr) {
		...
		//上报c2c消息已读
		c2CMsgReaded: function(options, cbOk, cbErr) {
			return MsgStore.c2CMsgReaded(options, cbOk, cbErr);
		},

		//上报群消息已读
		groupMsgReaded: function(options, cbOk, cbErr) {
		...
		//创建群-高级接口
		createGroupHigh: function(options, cbOk, cbErr) {
		...
		//处理加群申请(同意或拒绝)
		handleApplyJoinGroupPendency: function(options, cbOk, cbErr) {
		...
		//搜索群组(根据名称)
		searchGroupByName: function(options, cbOk, cbErr) {
		...
		//转让群组
		changeGroupOwner: function(options, cbOk, cbErr) {
		...
		//获取群成员角色
		getRoleInGroup: function(options, cbOk, cbErr) {
		...
		//进入大群
		applyJoinBigGroup: function(options, cbOk, cbErr) {
			return proto_applyJoinBigGroup(options, cbOk, cbErr);
		},
		//退出大群
		quitBigGroup: function(options, cbOk, cbErr) {
		...
		//获取最近会话
		getRecentContactList: function(options, cbOk, cbErr) {
		...
		//
		//上传文件接口（高版本浏览器）
		uploadFile: function(options, cbOk, cbErr) {
		...
		//上传图片或文件(Base64)接口
		uploadFileByBase64: function(options, cbOk, cbErr) {
			//请求参数
			var opt = {
